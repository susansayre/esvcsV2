function [expOut,deO_dUB] = land2outcomes(outputVarName,pubValVec,UBVec,P,useReal)
	...
	function p2OutVal = p2Out(signalVal,publicVals,privateVals,assumeUBs,P,outVarName,useReal)
		...
		optimalOffers = funeval(P.optOfferApprox.cVal.optOfferVector,P.optOfferApprox.basis,condEvalInfo);
		if nargout>1
