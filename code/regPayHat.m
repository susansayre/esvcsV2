...
regPayHat = (P.meanEnv + signals - offers - pubVals).*probAccept - (P.rho.re_rp*P.sig.re*P.sig.rp/condSDPriv).*probMarginal;
...
if nargout>1
    ...
    dregPayHat = -probAccept + (P.meanEnv + signals - offers - pubVals).*dprobAccept - P.rho.re_rp./condSDPriv.*dprobMarginal;
	...
	if nargout>2
        ...
        switch derivFlag
            case 'offer'               
                ...
                ddregPayHat = -2*dprobAccept +(P.meanEnv + signals - offers - pubVals).*ddprobAccept - P.rho.re_rp./condSDPriv*ddprobMarginal;
